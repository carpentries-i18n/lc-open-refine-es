...
## ¿Qué debería saber cuando trabajo con OpenRefine?
* No internet connection is needed, and none of the data or commands you enter in OpenRefine are sent to a remote server.
* Tu NO estás modificando los datos originales/crudos.
* Se guardará automáticamente, pero es importante [cerrar propiamente OpenRefine para que ello ocurra](https://github.com/OpenRefine/OpenRefine/wiki/Installation-Instructions).
